#!/usr/bin/env python3
"""
Maxwell TOC Extractor & Hierarchical Organizer - FIXED VERSION
=============================================================

FIXED VERSION that handles NoneType errors and creates a clean hierarchical structure
with numbered files and proper validation.

Filename Format: V1_C002_A0015.json (Volume 1, Chapter 002, Article 0015)
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('maxwell_toc_extractor_fixed.log'),
...
class MaxwellTOCExtractor:
    ...
    def __init__(self, base_output_dir: str = "Maxwell_TOC_Fixed"):
        """
    ...
    def extract_content_hierarchy(self, volume_data: Dict[str, Any], volume_num: int) -> Dict[str, Any]:
        ...
        for part_idx, part in enumerate(parts):
            ...
            for chapter_idx, chapter in enumerate(chapters):
                ...
                # Sort articles by page_start to ensure correct order
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description="Maxwell TOC Extractor & Hierarchical Organizer - FIXED VERSION")
    parser.add_argument("--base-dir", default="Maxwell_TOC_Fixed",
                       help="Base directory for output structure (default: Maxwell_TOC_Fixed)")
